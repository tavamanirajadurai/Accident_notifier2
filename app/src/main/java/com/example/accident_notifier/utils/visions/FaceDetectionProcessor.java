...
package com.example.accident_notifier.utils.visions;
...
import com.example.accident_notifier.utils.common.CameraImageGraphic;
...
import com.example.accident_notifier.utils.common.VisionProcessorBase;
...
public class FaceDetectionProcessor extends VisionProcessorBase<List<FirebaseVisionFace>> implements FaceDetectStatus {
    ...
    public FaceDetectionProcessor(Resources resources) {
        ...
        overlayBitmap = BitmapFactory.decodeResource(resources, R.drawable.button_selector);
    }
